...
| Production SFT/GRPO promotion | not_started | The v3 PEFT warmup, ms-swift 1-step smoke, mixed-pack 3-step smoke, rejection-SFT smoke, 400-document 480-step diagnostic, full4096 promptfix 1024-step SFT diagnostic, promptfix-based 182-record bounded rejection-SFT continuation, and 512-record promptfix candidate-pool review exist. They verify training-chain execution and train-only objective improvement. The bounded rejection-SFT continuation preserved heldout256 answer exact and slightly improved schema/ref/status/insufficient aggregate metrics, while the expanded candidate pool produced 377 rejection-SFT records but only 44 training-ready preference pairs; DPO and GRPO remain unapproved, no adapter is promoted as the default production AnswerPolicy, and no formal benchmark quality claim is accepted |
