...
| Production SFT/GRPO promotion | not_started | The v3 PEFT warmup, ms-swift 1-step smoke, mixed-pack 3-step smoke, rejection-SFT smoke, 400-document 480-step diagnostic, full4096 promptfix 1024-step SFT diagnostic, and promptfix-based 182-record bounded rejection-SFT continuation exist. They verify training-chain execution and train-only objective improvement. The bounded rejection-SFT continuation preserved heldout256 answer exact and slightly improved schema/ref/status/insufficient aggregate metrics, but preference-pair coverage remains too small for DPO and GRPO remains unapproved; no adapter is promoted as the default production AnswerPolicy, and no formal benchmark quality claim is accepted |
