...
| Full SFT/GRPO training | not_started | The v3 PEFT warmup, ms-swift 1-step smoke, and checkpoint diagnostic smokes exist, but no expanded SFT run, GRPO run, or trained-checkpoint quality claim is accepted |
