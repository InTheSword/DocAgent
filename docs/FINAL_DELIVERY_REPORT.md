...
| Production SFT/GRPO promotion | not_started | The v3 PEFT warmup, ms-swift 1-step smoke, mixed-pack 3-step smoke, rejection-SFT smoke, 400-document 480-step diagnostic, and full4096 promptfix 1024-step SFT diagnostic exist. They verify training-chain execution and train-only objective improvement, but no adapter is promoted as the default production AnswerPolicy, no GRPO run is approved, and no formal benchmark quality claim is accepted |
