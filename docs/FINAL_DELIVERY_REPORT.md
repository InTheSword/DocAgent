...
| Full SFT/GRPO training | not_started | The v3 PEFT warmup, ms-swift 1-step smoke, mixed-pack 3-step smoke, rejection-SFT smoke, and train-only heldout diagnostic smoke exist, but no expanded production SFT run, GRPO run, or trained-checkpoint quality claim is accepted |
